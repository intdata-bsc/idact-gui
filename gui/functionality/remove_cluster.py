...
class RemoveCluster(QWidget):
    ...
    def handle_complete_remove_cluster(self):
        ...
        self.parent.popup_window.show_message("The cluster has been successfully removed", WindowType.success)
    ...
    def handle_error_remove_cluster(self, exception):
        if isinstance(exception, KeyError):
            ...
            self.parent.popup_window.show_message("An error occured while removing cluster", WindowType.error)
