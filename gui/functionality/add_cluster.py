...
class AddCluster:
    ...
    def add_cluster(self):
        ...
        try:
            ...
            self.popUpWindow.show_message("Cluster already exists", WindowTitle.error)
        ...
        self.popUpWindow.show_message("The cluster has been successfully added", WindowTitle.success)
